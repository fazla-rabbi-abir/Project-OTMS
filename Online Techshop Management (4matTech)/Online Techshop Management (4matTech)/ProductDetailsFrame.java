...
public class ProductDetailsFrame extends JFrame implements ActionListener {
    JPanel panel1;
    JButton b1, b2,continueButton,backButton;
    JLabel nameLabel, infoLabel;
    ImageIcon productImage;

    public ProductDetailsFrame(String productName, String productInfo, String imagePath) {
        super("My Cart");
        ...
        infoLabel.setBounds(20, 60, 500, 200);
        panel1.add(infoLabel);

        // Display product image
        productImage = resizeImage(imagePath, 400, 400);
        JLabel imageLabel = new JLabel(productImage);
        imageLabel.setBounds(550, 20, 400, 400);
        panel1.add(imageLabel);
		
		continueButton = new JButton("Continue");
        continueButton.setBounds(20, 280, 100, 30);
